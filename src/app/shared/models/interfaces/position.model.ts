...
export class PiecePosition {
     ...
     */
    static transformNumberToColumn(columnNumberEquivalent: number): PositionColumnPiece {
        const array: PositionColumnPiece[] = ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H'];
        return array[columnNumberEquivalent];
    }
    ...
    static getColumnByModifier(column: PositionColumnPiece, modifier: number) {
        return PiecePosition.transformNumberToColumn(PiecePosition.transformColumnToNumber(column) + modifier);
    }
}
